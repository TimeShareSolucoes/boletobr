...
{
    public class HeaderRemessaDebitoAutomatico
    {

        public HeaderRemessaDebitoAutomatico(Banco banco,  DateTime? dataHora = null, bool teste = false)
        {

            this.DataGeracao = dataHora.GetValueOrDefault() == DateTime.MinValue ? DateTime.Now : dataHora.GetValueOrDefault();
            this.NumeroSequencial = banco.NumeroSequencialNsa;
            this.CodigoConvenio = banco.CodigoConvenio;
            this.NomeEmpresa = banco.NomeEmpresaNoBanco;
            this.CodigoBanco = banco.CodBanco;
            this.NomeBanco = banco.NomeBanco.Trim();
             
            this.VersaoLayout = "04";
            this.IdentificacaoServico = "DEBITO AUTOMATICO";
            this.RemessaTeste = teste; 
        ...
        /// “A”
        /// </summary>
        public string CodigoRegistro => "A";
