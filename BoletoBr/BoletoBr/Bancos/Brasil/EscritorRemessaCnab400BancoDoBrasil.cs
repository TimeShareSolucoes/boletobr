...
namespace BoletoBr.Bancos.Brasil
{
    public class EscritorRemessaCnab400BancoDoBrasil : IEscritorArquivoRemessaCnab400
    {
        ...
        public string EscreverDetalhe(DetalheRemessaCnab400 infoDetalhe, int numeroRegistro)
        {
            ...
            {
                if (primeiraInstrucao == null) detalhe = detalhe.PreencherValorNaLinha(159, 160, "07"); /*Caso primeira instrução não exista, o banco do brasil não permite mais que envie codigo repetido. Erro: "instruções codificadas repetidas"*//*07 = Não protestar*/
                else detalhe = detalhe.PreencherValorNaLinha(159, 160, "00");
            }
