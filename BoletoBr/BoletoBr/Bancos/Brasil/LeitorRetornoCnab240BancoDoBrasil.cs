...
namespace BoletoBr.Bancos.Brasil
{
    public class LeitorRetornoCnab240BancoDoBrasil : ILeitorArquivoRetornoCnab240
    {
        ...
        public HeaderRetornoCnab240 ObterHeader(string linha)
        {
            ...
            objRetornar.ConvenioNumeroCobranca = linha.ExtrairValorDaLinha(33, 41).BoletoBrToLong();
            ...
            objRetornar.ContaCorrente = linha.ExtrairValorDaLinha(59, 70).BoletoBrToInt();
        ...
        public DetalheSegmentoURetornoCnab240 ObterRegistrosDetalheU(string linha)
        {
            ...
            objRetornar.DataOcorrenciaPagador = linha.ExtrairValorDaLinha(158, 165).BoletoBrToInt();
