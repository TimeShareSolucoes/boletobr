    ...
    public class EscritorRemessaCnab400Itau : IEscritorArquivoRemessa
    {
        ...
        public string EscreverDetalhe(Boleto boleto, int numeroRegistro)
        {
            ...
            try
            {
                ...
                detalhe = detalhe.PreencherValorNaLinha(38, 62, boleto.NumeroDocumento.PadLeft(25, ' '));
                ...
                detalhe = detalhe.PreencherValorNaLinha(71, 83, boleto.QuantidadeMoeda.ToString());
                    // Quantidade de Moeda Variável
                detalhe = detalhe.PreencherValorNaLinha(84, 86, boleto.CarteiraCobranca.Codigo.PadLeft(3, ' '));
                ...
                detalhe = detalhe.PreencherValorNaLinha(127, 139,
                    String.Format("{0:0.##}", boleto.ValorBoleto).PadLeft(11, '0')); // Valor Nominal do Título
                detalhe = detalhe.PreencherValorNaLinha(140, 142, boleto.BancoBoleto.CodigoBanco.PadLeft(3, '0'));
                    // Nro do Banco na Câmara de Compensação
                ...
                detalhe = detalhe.PreencherValorNaLinha(150, 150, boleto.Aceite);
                ...
                detalhe = detalhe.PreencherValorNaLinha(161, 173,
                    String.Format("{0:0.##}", boleto.JurosMora).PadLeft(11, '0')); // Valor de Mora Por Dia de Atraso
                ...
                detalhe = detalhe.PreencherValorNaLinha(180, 192,
                    String.Format("{0:0.##}", boleto.ValorDesconto).PadLeft(11, '0'));
                ...
                detalhe = detalhe.PreencherValorNaLinha(206, 218,
                    String.Format("{0:0.##}", boleto.ValorAbatimento).PadLeft(11, '0'));
                ...
                detalhe = detalhe.PreencherValorNaLinha(219, 220, boleto.SacadoBoleto.CpfCnpj.Length == 11 ? "01" : "02");
                    // Identificação do tipo de inscrição/sacado
                ...
                detalhe = detalhe.PreencherValorNaLinha(327, 334, boleto.SacadoBoleto.EnderecoSacado.Cep.PadLeft(8, ' '));
                    // Cep do Sacado
                ...
                detalhe = detalhe.PreencherValorNaLinha(386, 391, boleto.DataJurosMora.ToString("d").Replace("/", ""));
                    // Data de Mora
                ...
                detalhe = detalhe.PreencherValorNaLinha(394, 394, string.Empty.PadRight(1, '0'));
                    // Complemento do Registro
                detalhe = detalhe.PreencherValorNaLinha(395, 400, _numeroRegistro.ToString().PadLeft(6, ' '));
