    ...
    public class LeitorRetornoCnab240Bradesco : ILeitorArquivoRetornoCnab240
    {
       ...
       public LeitorRetornoCnab240Bradesco(List<string> linhasArquivo)
        ...
        public HeaderLoteRetornoCnab240 ObterHeaderLote(string linha)
        {
            ...
            objRetornar.ContaCorrente = linha.ExtrairValorDaLinha(60, 71).BoletoBrToLong();
        ...
        public DetalheSegmentoTRetornoCnab240 ObterRegistrosDetalheT(string linha)
        {
            ...
            //objRetornar.DataVencimento = (DateTime) linha.ExtrairValorDaLinha(74, 81).ToString().ToDateTimeFromDdMmAa();
        ...
        public DetalheSegmentoURetornoCnab240 ObterRegistrosDetalheU(string linha)
        {
            ...
            //objRetornar.DataOcorrencia = Convert.ToDateTime(linha.ExtrairValorDaLinha(138, 145).ToString().ToDateTimeFromDdMmAa());
            //objRetornar.DataCredito = Convert.ToDateTime(linha.ExtrairValorDaLinha(146, 153).ToString().ToDateTimeFromDdMmAa());
            objRetornar.CodigoOcorrenciaPagador = linha.ExtrairValorDaLinha(154, 157);
            objRetornar.DataOcorrenciaPagador = Convert.ToDateTime(linha.ExtrairValorDaLinha(158, 165).ToString().ToDateTimeFromDdMmAa());
        ...
        public TrailerLoteRetornoCnab240 ObterTrailerLote(string linha)
        {
            ...
            objRetornar.QtdTitulosCobrancaVinculada = linha.ExtrairValorDaLinha(47, 52).BoletoBrToLong();
