    ...
    public class EscritorRemessaCnab240CefSicgb : IEscritorArquivoRemessa
    {
        ...
        public string EscreverHeader(Boleto boleto, int numeroRegistro)
        {
            ...
            try
            {
                ...
                header = header.PreencherValorNaLinha(53, 57,
                    boleto.CedenteBoleto.ContaBancariaCedente.Agencia.PadLeft(5, '0')); // Agência Mantenedora da Conta
        ...
        public string EscreverHeaderDeLote(Boleto boleto, int numeroRegistro)
        {
            ...
            try
            {
                ...
                headerlote = headerlote.PreencherValorNaLinha(9, 9, "".PadRight(7, ' '));
                //  Tipo de Operação           
                ...
                headerlote = headerlote.PreencherValorNaLinha(18, 18,
                    boleto.CedenteBoleto.CpfCnpj.Length == 11 ? "01" : "02"); // Tipo de Inscrição da Empresa
                ...
                headerlote = headerlote.PreencherValorNaLinha(59, 59,
                    boleto.CedenteBoleto.ContaBancariaCedente.DigitoConta); // Dígito Verificador da Conta
                headerlote = headerlote.PreencherValorNaLinha(60, 65, boleto.BancoBoleto.CodigoBanco);
        ...
        public string EscreverDetalheSegmentoP(Boleto boleto, int numeroLote, int numeroRegistro)
        {
            ...
            try
            {
                ...
                detalhe = detalhe.PreencherValorNaLinha(109, 109, boleto.Aceite.Equals("S") ? "S" : "N");
