    ...
    public class EscritorRemessaCnab240CefSicgb : IEscritorArquivoRemessa
    {
        ...
        public string EscreverDetalhe(Boleto boleto, int numeroRegistro)
        {
            ...
            try
            {
                ...
                detalhe = detalhe.PreencherValorNaLinha(9, 13, "");// Nº Sequencial do Registro no Lote
                ...
                detalhe = detalhe.PreencherValorNaLinha(18, 22, "");// Agência Mantenedora da Conta
                detalhe = detalhe.PreencherValorNaLinha(23, 23, "");// Dígito Verificador da Agência
                detalhe = detalhe.PreencherValorNaLinha(24, 29, "");// Código do Convênio no Banco
                ...
                detalhe = detalhe.PreencherValorNaLinha(43, 57, "");// Identificaçao do Título no Banco
                detalhe = detalhe.PreencherValorNaLinha(58, 58, "");// Código da Carteira
                ...
                detalhe = detalhe.PreencherValorNaLinha(63, 73, "");// Número do Documento de Cobrança
                detalhe = detalhe.PreencherValorNaLinha(74, 77, "");// Uso Exclusivo CAIXA
                detalhe = detalhe.PreencherValorNaLinha(78, 85, "");// Data de Vencimento do Título
                ...
                detalhe = detalhe.PreencherValorNaLinha(109, 109, "");// Identific. de Título Aceito/Não Aceito
                detalhe = detalhe.PreencherValorNaLinha(110, 117, "");// Data da Emissão de Título
                ...
                detalhe = detalhe.PreencherValorNaLinha(127, 141, "");// Juros de Mora por Dia/Taxa
